                ...
                child: CupertinoTabBar(
                  ...
                  items: const [
                    BottomNavigationBarItem(
                        icon: Icon(Iconsax.home, color: darkPurpleColor),
                        label: "Home"),
                    BottomNavigationBarItem(
                        ...
                        label: "Search"),
                    BottomNavigationBarItem(
                        icon: Icon(Iconsax.add_square, color: darkPurpleColor),
                        label: "Add"),
                    BottomNavigationBarItem(
                        icon: Icon(Iconsax.pet, color: darkPurpleColor),
                        label: "Pet"),
                    BottomNavigationBarItem(
                        icon: Icon(Iconsax.user, color: darkPurpleColor),
                        label: "Profile"),
                  ],
